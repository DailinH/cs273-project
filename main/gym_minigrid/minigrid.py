...
class Door(WorldObj):
    def __init__(self, color='blue', is_open=False, is_locked=False):
        super().__init__('door', color='blue')
...
class MiniGridEnv(gym.Env):
    ...
    def step(self, action):
        ...
        # get current position & current cell
        ...
        # Move forward
            ...
            # print('going forward action')
            # print(fwd_cell)
            # print(fwd_cell.can_overlap())
            ...
            if fwd_cell != None and fwd_cell.type == 'trap':
                self.agent_pos = (int((self.width+1) / 2), int((self.height+1) / 2))
        ...
        # Toggle/activate an object
            ...
            if cur_cell != None and cur_cell.type == 'door':
                self.agent_pos = (1,1)
                cur_cell.is_open = False
            if fwd_cell:
    ...
    def gen_obs(self):
        ...
        DailinH: fully-observable version
        """
        ...
        # encode everything into a numpy array
        image = grid.encode()
